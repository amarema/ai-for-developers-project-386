...
<header class="border-b border-primary/10 bg-background/70 backdrop-blur-xl sticky top-0 z-10 shadow-sm">
	<div class="container mx-auto flex items-center justify-between px-4 py-3">
		<a href="/" class="flex items-center gap-2 font-black text-lg tracking-tight group">
			<span class="flex items-center justify-center h-8 w-8 rounded-xl bg-primary text-primary-foreground shadow-sm group-hover:shadow-md group-hover:scale-105 transition-all shrink-0">
				<CalendarDays class="h-4 w-4" />
			</span>
			<span class="hidden sm:inline bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">Calendar</span>
		</a>
